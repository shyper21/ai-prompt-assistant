...
export default function IdeaStep({ idea, error, t, onIdeaChange, onNext }: IdeaStepProps) {
  return (
    <section className="glass-panel overflow-hidden rounded-lg">
      <div className="border-b border-white/10 p-5">
        ...
        <h2 className="mt-2 text-2xl font-black text-white">{t.ideaTitle}</h2>
